...
<body class="hold-transition login-page" style="background-image: url('<?php echo base_url('assets') ?>/img/Login Background.jpg');background-repeat: no-repeat;
    ...
    <div class="card-body login-card-body" >
      <form action="<?php echo base_url('login/') ?>login1" method="post">
        ...
        <p class="mb-3"  style="text-align: right;">
          <a href="<?php echo base_url('login/') ?>forgot">I forgot my password</a>
        </p>

        <div class="row mb-3">
            <button type="submit" class="btn btn-block btn-progo-orange">Log In</button>
         <!-- /.col -->
        </div>
      ...
      <p class="mb-1" style="text-align: center;">
        <a href="<?php echo base_url('login/') ?>forgot">Don't have an account? <b>Register</b></a>
      </p>
